...
### Enum / Enumeration (`java.lang.Enum`)
| Methode | Rückgabetyp | Statisch |
| :--- | :--- | :---: |
...
## 7. Testing & Mocking (JUnit & Mockito)
